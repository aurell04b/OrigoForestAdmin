...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('deals');

// This file contains the logic of every route in Forest Admin for the collection deals:
...
// Create a Deal
router.post('/deals', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Deal
router.put('/deals/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Deal
router.delete('/deals/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Deals
router.get('/deals', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Deals
router.get('/deals/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Export a list of Deals
router.get('/deals.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Deals
router.delete('/deals', permissionMiddlewareCreator.delete(), (request, response, next) => {
