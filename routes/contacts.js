...
// This file contains the logic of every route in Forest Admin for the collection contacts:
...
// Get a Contact
router.get('/contacts/:recordId(?!count)', permissionMiddlewareCreator.details(), (request, response, next) => {
