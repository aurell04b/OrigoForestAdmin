...
// This file contains the logic of every route in Forest Admin for the collection arInternalMetadata:
...
router.get('/arInternalMetadata/:recordId(?!count)', permissionMiddlewareCreator.details(), (request, response, next) => {
