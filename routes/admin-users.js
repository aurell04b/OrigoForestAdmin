...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('admin_users');

// This file contains the logic of every route in Forest Admin for the collection admin_users:
...
router.post('/admin_users', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/admin_users/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/admin_users/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/admin_users', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Admin Users
router.get('/admin_users/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get an Admin User
router.get('/admin_users/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Admin Users
router.get('/admin_users.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Admin Users
router.delete('/admin_users', permissionMiddlewareCreator.delete(), (request, response, next) => {
