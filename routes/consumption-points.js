...
const { consumption_points } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('consumption_points');

// This file contains the logic of every route in Forest Admin for the collection consumption_points:
...
router.post('/consumption_points', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/consumption_points/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/consumption_points/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/consumption_points', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/consumption_points/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Consumption Point
router.get('/consumption_points/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/consumption_points.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/consumption_points', permissionMiddlewareCreator.delete(), (request, response, next) => {
