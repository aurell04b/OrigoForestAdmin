...
const { mark_to_markets } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('mark_to_markets');

// This file contains the logic of every route in Forest Admin for the collection mark_to_markets:
...
router.post('/mark_to_markets', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/mark_to_markets/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/mark_to_markets/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/mark_to_markets', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/mark_to_markets/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
router.get('/mark_to_markets/:recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
router.get('/mark_to_markets.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
router.delete('/mark_to_markets', permissionMiddlewareCreator.delete(), (request, response, next) => {
